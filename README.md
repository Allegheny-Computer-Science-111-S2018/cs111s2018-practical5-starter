...
# cs111s2018-practical5-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the assignment for Practical 5 in Computer Science 111.
...
* The `MadLibs` program must:
  ...
  * Read in multiple numbers and words from a file and use appropriate variables
  	to store them 
...
you can go to the [Computer Science 111 Practical 5
Starter](https://github.com/Allegheny-Computer-Science-111-S2018/cs111-S2018-practical5-starter)
