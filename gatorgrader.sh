...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfive/ \
  ...
  # --> GatorGrader CHECK: at least 4 "String" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfive \
                                     --checkfiles MadLibs.java --fragments "String" --fragmentcounts 4

  # --> GatorGrader CHECK: at least 2 "int" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfive \
                                     --checkfiles MadLibs.java --fragments "int" --fragmentcounts 2
  # --> GatorGrader CHECK: at least 2 "int" fragment exists in the code
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/main/java/practicalfive \
                                    --checkfiles MadLibs.java --fragments "System.out.print" --fragmentcounts 3
